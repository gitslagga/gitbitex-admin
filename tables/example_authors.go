...
func GetExampleAuthorTable(ctx *context.Context) (authorsTable table.Table) {
	...
	info.SetTable("example_author").SetTitle("作者").SetDescription("作者")
	...
	formList.SetTable("example_author").SetTitle("作者").SetDescription("作者")
