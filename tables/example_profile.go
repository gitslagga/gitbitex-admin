...
func GetExampleProfileTable(ctx *context.Context) table.Table {
	...
	info.SetTable("example_profile").SetTitle("信息").SetDescription("信息")
	...
	formList.SetTable("example_profile").SetTitle("信息").SetDescription("信息")
