...
func GetExampleEmployeeTable(ctx *context.Context) table.Table {
	...
	info.SetTable("example_employee").SetTitle("雇员").SetDescription("雇员").
	...
	formList.SetTable("example_").SetTitle("雇员").SetDescription("雇员")
